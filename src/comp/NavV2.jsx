...
const NavBar = ({ account, disconnectMetaMask }) => {
                        ...
                        {account && (
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <span className="inline-flex items-center justify-center px-2 py-0.5 ms-3 text-xs font-medium text-gray-500 bg-gray-200 rounded-sm">
